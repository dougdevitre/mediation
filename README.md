...
**Free, open-source practice tools for family mediators — grounded in published model standards, built for real-world use.**
...
**Access to Mediation changes that.** It provides a complete, standards-compliant practice toolkit — reference guides, screening checklists, interactive tools, and decision-flow diagrams — all mapped to the two authoritative frameworks that govern family mediation in the United States:
...
**[Launch Access to Mediation](https://dougdevitre.github.io/mediation/)** — Parenting Plan Builder, Compliance Dashboard, CE Tracker, Scenario Search, and Reference Guide browser — all working directly in your browser.
...
- **Ethics & Compliance Dashboard** — Self-audit your practice against 46 compliance items across 10 standards areas. Get an overall compliance score, per-section breakdown, and a prioritized corrective action list.
...
7. **Deliver the CLE presentation** at your next conference
...
| Standard Area | 2025 Family (AFCC/ABA) | 2005 General (ABA/AAA/ACR) | Reference |
|---|---|---|---|
...
| **Access to Mediation** | **Standards-compliant family mediation tools** ← You are here |
